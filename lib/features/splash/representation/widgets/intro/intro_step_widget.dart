...
import 'package:viora_app/features/splash/representation/widgets/intro/buttons/primary_button.dart';
import 'package:viora_app/features/splash/representation/widgets/intro/buttons/secondary_button.dart';
import 'package:viora_app/features/splash/representation/widgets/intro/intro_progress_widget.dart';
...
class _IntroStepWidgetState extends State<IntroStepWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    final isLastStep = widget.currentStep >= 3;
              ...
              AnimatedOpacity(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: PrimaryStepButton(
                        label: isLastStep ? 'Completed' : 'Next',
                        icon: isLastStep
                            ? Icons.check_rounded
                            : widget.continueIcon,
                        onPressed: _isCompleting
